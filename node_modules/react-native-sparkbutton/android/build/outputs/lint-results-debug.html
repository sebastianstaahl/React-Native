...
Check performed at Thu Jul 20 19:41:08 CEST 2017.<br/>
2 errors and 6 warnings found:<br/><br/>
...
<tr>
<td class="countColumn">1</td><td class="issueColumn"><img border="0" align="top" width="15" height="15" alt="Error" src="data:image/png;base64," />
<a href="#WrongCall">WrongCall: Using wrong draw/layout method</a>
</td></tr>
<tr>
<td class="countColumn">2</td><td class="issueColumn"><img border="0" align="top" width="16" height="15" alt="Warning" src="data:image/png;base64,"/>
...
<tr><td></td><td class="categoryColumn"><a href="#MissingIssues">Disabled Checks (16)</a>
</td></tr></table>
<br/>
...
<span class="location"><a href="../../src/main/java/com/github/godness84/RNRecyclerViewList/RecyclerViewBackedScrollViewManager.java">../../src/main/java/com/github/godness84/RNRecyclerViewList/RecyclerViewBackedScrollViewManager.java</a>:107</span>: <span class="message">Implicitly using the default locale is a common source of bugs: Use <code>String.format(Locale, ...)</code> instead</span><br /><pre class="errorlines">
<span class="lineno"> 104</span>             }
<span class="lineno"> 105</span> 
<span class="lineno"> 106</span>             default:
<span class="lineno"> 107</span>                 throw new IllegalArgumentException(<span class="errorspan">String.format(</span>
<span class="lineno"> 108</span>                         "Unsupported command %d received by %s.",
<span class="lineno"> 109</span>                         commandType,
</pre>
</div>
...
<span class="lineno">  19</span>         minSdkVersion 16
<span class="lineno">  20</span>         <span class="errorspan">targetSdkVersion 22</span>
<span class="lineno">  21</span>         versionCode 1
<span class="lineno">  22</span>         versionName "1.0"
</pre>
</div>
...
<a name="WrongCall"></a>
<div class="issue">
<div class="id"><a href="#" title="Return to top">WrongCall: Using wrong draw/layout method</a><div class="issueSeparator"></div>
</div>
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/github/godness84/RNRecyclerViewList/RecyclerViewBackedScrollView.java">../../src/main/java/com/github/godness84/RNRecyclerViewList/RecyclerViewBackedScrollView.java</a>:515</span>: <span class="message">Suspicious method call; should probably call "<code>layout</code>" rather than "<code>onLayout</code>"</span><br /><pre class="errorlines">
<span class="lineno"> 512</span>                 public void run() {
<span class="lineno"> 513</span>                     mRequestedLayout = false;
<span class="lineno"> 514</span>                     layout(getLeft(), getTop(), getRight(), getBottom());
<span class="lineno"> 515</span>                     <span class="errorspan">onLayout(false, getLeft(), getTop(), getRight(), getBottom());</span>
<span class="lineno"> 516</span>                     Log.d(TAG, "run layout in Recycler");
...
Explanation: Using wrong draw/layout method.</div>
<div class="explanation">
Custom views typically need to call <code>measure()</code> on their children, not <code>onMeasure</code>. Ditto for onDraw, onLayout, etc.
</div>
<br/><div class="moreinfo">More info: </div><br/>To suppress this error, use the issue id "WrongCall" as explained in the <a href="#SuppressInfo">Suppressing Warnings and Errors</a> section.<br/>
</div>
...
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:16</span>: <span class="message">Old buildToolsVersion 23.0.1; recommended version is 23.0.3 or later</span><br /><pre class="errorlines">
<span class="lineno">  13</span> 
<span class="lineno">  14</span> android {
<span class="lineno">  15</span>     compileSdkVersion 23
<span class="lineno">  16</span>     <span class="errorspan">buildToolsVersion "23.0.1"</span>
<span class="lineno">  17</span> 
<span class="lineno">  18</span>     defaultConfig {
</pre>
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:35</span>: <span class="message">A newer version of com.android.support:recyclerview-v7 than 23.0.1 is available: 25.3.1</span><br /><pre class="errorlines">
<span class="lineno">  32</span> 
<span class="lineno">  33</span> dependencies {
<span class="lineno">  34</span>     compile 'com.facebook.react:react-native:+'
<span class="lineno">  35</span>     <span class="errorspan">compile 'com.android.support:recyclerview-v7:23.0.1'</span>
...
<span class="lineno">  32</span> 
<span class="lineno">  33</span> dependencies {
<span class="lineno">  34</span>     <span class="errorspan">compile 'com.facebook.react:react-native:+'</span>
<span class="lineno">  35</span>     compile 'com.android.support:recyclerview-v7:23.0.1'
<span class="lineno">  36</span> }
</pre>
</div>
<div class="metadata">Note: This issue has an associated quickfix operation in Android Studio/IntelliJ<br>
...
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/github/godness84/RNRecyclerViewList/RecyclerViewBackedScrollView.java">../../src/main/java/com/github/godness84/RNRecyclerViewList/RecyclerViewBackedScrollView.java</a>:70</span>: <span class="message">Custom view <code>RecyclableWrapperViewGroup</code> is missing constructor used by tools: <code>(Context)</code> or <code>(Context,AttributeSet)</code> or <code>(Context,AttributeSet,int)</code></span><br /><pre class="errorlines">
<span class="lineno">  67</span>      * (dimensions has been set in layouting process) so that size of this view match the size of
<span class="lineno">  68</span>      * the view it wraps.
<span class="lineno">  69</span>      */
<span class="lineno">  70</span>     static class <span class="errorspan">RecyclableWrapperViewGroup extends ViewGroup {</span>
<span class="lineno">  71</span> 
<span class="lineno">  72</span>         private ReactListAdapter mAdapter;
</pre>
</div>
...
Category: Usability</div>
Severity: <span class="warning">Warning</span><div class="summary">
Explanation: Missing support for Firebase App Indexing Api.</div>
<div class="explanation">
